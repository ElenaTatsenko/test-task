...
const UserCard = ({id, avatar, user, tweets, followers, onClick, followed }) => {
  ...
  return (
    <Card>
      ...
      <BgBox alt="bacground" src={background}></BgBox>
        ...
        <Button onClick={handleClick} text={ !isFollowing ? 'Follow' : 'Following'} style={{ backgroundColor: !isFollowing ? '#EBD8FF' : '#5CD3A8' }}></Button>
